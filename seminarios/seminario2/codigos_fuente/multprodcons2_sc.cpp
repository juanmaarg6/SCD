...
// *****************************************************************************
// clase para monitor buffer, version FIFO, semántica SC, múltiples prod. y múltiples cons.

class MultProdCons2SC
{
 private:
 ...
 public:                    // constructor y métodos públicos
   MultProdCons2SC(  ) ;    // constructor
   int  leer();                // extraer un valor (sentencia L) (consumidor)
   void escribir( int valor ); // insertar un valor (sentencia E) (productor)
} ;
// -----------------------------------------------------------------------------

MultProdCons2SC::MultProdCons2SC(  )
{
   primera_libre = 0 ;
   primera_ocupada = 0;
...
void MultProdCons2SC::escribir( int valor )
{
   // ganar la exclusión mutua del monitor con una guarda
   unique_lock<mutex> guarda( cerrojo_monitor );
...
void funcion_hebra_productora( MultProdCons2SC * monitor, int num_hebra )
{
...
void funcion_hebra_consumidora( MultProdCons2SC * monitor, int num_hebra )
{
