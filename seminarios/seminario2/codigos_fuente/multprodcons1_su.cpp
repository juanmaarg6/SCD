...
// *****************************************************************************
// clase para monitor buffer, version LIFO, semántica SU, múltiples prod. y múltiples cons.

class MultProdCons1SU : public HoareMonitor
{
 private:
 ...
 public:                    // constructor y métodos públicos
   MultProdCons1SU(  ) ;    // constructor
   int  leer();                // extraer un valor (sentencia L) (consumidor)
   void escribir( int valor ); // insertar un valor (sentencia E) (productor)
} ;
// -----------------------------------------------------------------------------

MultProdCons1SU::MultProdCons1SU(  )
{
   primera_libre = 0 ;
   ocupadas = newCondVar();
   libres = newCondVar();
...
void MultProdCons1SU::escribir( int valor )
{
...
void funcion_hebra_productora( MRef<MultProdCons1SU> monitor, int num_hebra )
{
...
void funcion_hebra_consumidora( MRef<MultProdCons1SU> monitor, int num_hebra )
{
...
int main()
{
   ...
   cout << "----------------------------------------------------------------------------------"      << endl
        << "Problema de los productores-consumidores (Mult prod/cons, Monitor SU, buffer LIFO). "    << endl
        << "----------------------------------------------------------------------------------"      << endl
        << flush ;

   MRef<MultProdCons1SU> monitor = Create<MultProdCons1SU>();
